...
function UserInfoComp() {
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Dialog fullWidth={true} maxWidth={'lg'} open={openAddrDialog} onClose={handleAddrClose}>
      ...
      <Dialog fullWidth={true} maxWidth={'lg'} open={openAccDialog} onClose={handleAccClose}>
      ...
      <Dialog fullWidth={true} maxWidth={'sm'} open={openRiskAppDialog} onClose={handleRiskClose}>
