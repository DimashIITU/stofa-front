        ...
        <Box sx={style}>
          <Card>
            ...
            <CardContent>
              ...
              {quantityError ? <p style={{ color: 'red' }}>Quantity cannot be 0.</p> : <></>}
              {marginError ? <p style={{ color: 'red' }}>Margin exceeded.</p> : <></>}
              {marginError || quantityError ? <></> : <br />}
              <Stack direction="row" spacing={16.1}>
                <label>Price: </label>
                <TextField sx={{ width: '15ch' }} value={props.stockData.price} disabled={true} />
              </Stack>
              <br />
              <Stack direction="row" spacing={5.5}>
                <label>Margin required: </label>
                <TextField sx={{ width: '15ch' }} value={marginRequired} disabled={true} />
              </Stack>
              <br />
              <Stack direction="row" spacing={4.9}>
                <label>Margin available: </label>
                <TextField sx={{ width: '15ch' }} value={marginAvailable} disabled={true} />
              </Stack>
            </CardContent>
            <Divider />
