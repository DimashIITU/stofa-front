...
export default function RiskAppetite() {
  ...
  return (
    <Grid container alignItems="stretch">
      ...
      <Grid className="right-pane" item md={4} xs={12} style={{ padding: '0rem' }}>
        <Stack>
          <Container component="main" maxWidth="xs">
                ...
                <Box>
                  <FormControl onSubmit={handleSubmit}>
                    <FormLabel id="demo-radio-buttons-group-label">
                      Determining an appropriate investment strategy involves balancing potential
                      risk against expected returns. When making investment decisions, do you give
                      more weight to potential losses or potential gains?
                    </FormLabel>
                    <RadioGroup
                      row
                    ...
                    <br />
                    <FormLabel id="demo-radio-buttons-group-label">
                      How would you characterize your willingness to accept investment risk in order
            ...
            <Dialog
              ...
              <DialogTitle id="alert-dialog-title">{'Do you confirm all details?'}</DialogTitle>
              <DialogContent>
