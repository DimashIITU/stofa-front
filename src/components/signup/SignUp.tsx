...
export default function SignUp() {
  ...
  return (
    <Grid container alignItems="stretch">
      ...
      <Grid className="right-pane" item md={5} xs={12} style={{ padding: '0rem' }}>
        <Stack>
          <Container component="main" maxWidth="xs">
              ...
              <Box
                ...
                <Box>
                  <form onSubmit={handleSubmit}>
                    ...
                    <Button sx={{ marginTop: 1 }} fullWidth variant="contained" type={'submit'}>
                      Next
                    </Button>
                  </form>
                </Box>
            ...
            <Card variant="outlined" style={card_1}>
              <Button fullWidth variant="outlined" type={'submit'} onClick={gotosignin}>
                Sign-in
              </Button>
            </Card>
          </Container>
